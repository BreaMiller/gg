...
import { Coins, Sparkles, Play, Download, Trophy, Gift, Crown, Zap, ArrowRight } from 'lucide-react';
      ...
      <FadeInSection>
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent mb-2">
            Amped Credits & Pricing
          </h1>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Amped operates on a credit system to reward creation and engagement. Credits power everything from game generation to gameplay.
          </p>
        </div>
      </FadeInSection>
