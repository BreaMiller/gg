  ...
  const faqCategories = [
    {
      ...
      items: [
        {
          question: 'What is Amped?',
          answer: 'Amped is an AI-powered gaming platform that allows users to create games from simple text prompts. Using advanced Unity C# generation and expert game development patterns, you can transform your ideas into playable games within minutes.'
        },
        {
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          Find answers to common questions about Amped, game creation, credits, and community features
        </p>
      </div>
